...
(58, 'scot', '+923338080120', '2017-01-21 08:07:28', '1', 1),
...
(258, 58, 'This is Osborn''s Automotive: Just reminding you of your appointment tomorrow. If you need to reschedule or unable to make it, please let us know so we can adjust our schedule.', NULL, NULL, '1', '2017-01-21 08:07:28', '1', '0', 1);
...
CREATE TABLE IF NOT EXISTS `inboundsms` (
  ...
  `msgStatus` enum('Yes','No') NOT NULL DEFAULT 'No'
...
INSERT INTO `inboundsms` (`id`, `number`, `message`, `mediaUrl`, `msgStatus`) VALUES
(1, '+919477989708', 'this is test message', 'http://localhost:81/rsstexting/themes/backend/assets/admin/layout4/img/RepairShopSolutions-Logo.png', 'Yes'),
(2, '+919477989708', 'this is test message1', '', 'Yes'),
(5, ' 919477989708', 'this is today test1', '', 'Yes'),
(6, '+13108096967', 'Repky from cell', '', 'Yes'),
(7, '+13108096967', 'A second reply from my cell', '', 'Yes'),
(8, '+13108096967', 'Third reply from cell', '', 'Yes'),
(9, '+13108096967', 'Reply again', '', 'Yes'),
...
(46, 'SITE_DEFAULT_TIMEZONE', '', 'S', '', NULL, 'America/Los_Angeles', NULL, 0);
