...
if ($mode == 'production') {
	$config['base_url']	= "http://app.rsstexting.com/"; //"http://rsstexting.com/";
} else { //local
	$config['base_url']	= "http://localhost:81/rsstexting/";
}
...
//DB
if ($mode == 'production') {
	$config['hostname'] = "us-cdbr-azure-west-b.cleardb.com";
	$config['db'] = "rsstextingdb";
	$config['db_username'] = "bd284d3f5c6e3f"; 
	$config['db_password'] = "e6ba726c"; 
} else if ($mode == 'godaddy_production') {
	$config['hostname'] = "localhost";
	$config['db'] = "rsstextingborn";
	$config['db_username'] = "rsstexting2016"; 
	$config['db_password'] = "Bs2mo;,{#X)Q"; 
} else { //local
	$config['hostname'] = "localhost"; 
	$config['db'] = "rsstextingborn";
...
if($mode == 'local'){
	$config['basepath'] 				    =  $_SERVER['DOCUMENT_ROOT'].'/rsstexting/';
}else{
...
$config['clientdate']    			= 		(date ("Y-m-d")); // Do Not Touch 
$config['clienttime']				= 		(date ("H:i:s")); // Do Not Touch 
$config['clientbrowser']			= 		getenv("HTTP_USER_AGENT"); // Do Not Touch 
$config['clientip']					= 		$_SERVER['REMOTE_ADDR']; // Do Not Touch 

$config['clienturl']				= 		getenv("HTTP_REFERER"); // Do Not Touch 
?>