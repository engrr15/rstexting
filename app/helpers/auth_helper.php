 ...
 */
	...
	function  getBanStatus($uname)
	{
        ...
        function  getSuspendedStatus($uname)
	{
		...
		$sus_status = $sus_status->row();
		if(isset($sus_status->suspend_status))		
        ...
        function  getUserStatus($uname)
	{
		...
		$CI->load->model('common_model');
		$condition =array('users.user_name'=>$uname);
		$sus_status= $CI->common_model->getTableData('users',$condition,'users.user_status');
		$sus_status = $sus_status->row();
		if(isset($sus_status->user_status))		
			return $sus_status->user_status;
		else
		 	return false;
